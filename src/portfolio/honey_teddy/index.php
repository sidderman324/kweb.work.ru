...
<head>
	...
	<meta name="description" content="HONEY TEDDY витамины для волос" />
	<title>HONEY TEDDY витамины для волос</title>
</head>
	...
	<div class="container">
		...
		<div class="case__block">
			<div class="case__block-head">
				...
				<h1 class="case__title case__title--main">HONEY TEDDY витамины для волос</h1>
				<p class="case__text case__text--date">Дата выпуска: 20.02.2018</p>
			</div>
			<div class="case__frame-wrapper">
				<div class="case__frame">
					<img src="/img/honey_teddy_site.png" alt="" class="case__frame-img">
				</div>
			</div>
		</div>
		<div class="case__block">
			<div class="case__block-head">
				...
				<p class="case__text">Вывод на рынок нового продукта. Поиск и тестирование каналов продвижения</p>
			</div>
