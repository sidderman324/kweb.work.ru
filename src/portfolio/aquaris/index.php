...
<head>
	...
	<meta name="description" content="AQUARIUS система автополива" />
	<title>AQUARIUS система автополива</title>
</head>
	...
	<div class="container">
		...
		<div class="case__block">
			<div class="case__block-head">
				...
				<h1 class="case__title case__title--main">AQUARIUS система автополива</h1>
		...
		<div class="case__block">
			<div class="case__block-head">
				...
				<p class="case__text">Поиск новых клиентов для своей продукции. Ориентация на коттеджи и большие объемы полива. В портфолио крупные клиенты</p>
			</div>
