...
<head>
	...
	<meta name="description" content="МИНИСТЕРСТВО ПРОМЫШЛЕННОСТИ И НАУКИ Свердловской области" />
	<title>МИНИСТЕРСТВО ПРОМЫШЛЕННОСТИ И НАУКИ Свердловской области</title>
</head>
	...
	<div class="container">
		...
		<div class="case__block">
			<div class="case__block-head">
				...
				<h1 class="case__title case__title--main">МИНИСТЕРСТВО ПРОМЫШЛЕННОСТИ И НАУКИ Свердловской области</h1>
				<p class="case__text case__text--date">Дата выпуска: 20.02.2018</p>
			</div>
			<div class="case__frame-wrapper">
				<div class="case__frame">
					<img src="/img/science_prom_site.png" alt="" class="case__frame-img">
				</div>
			</div>
		</div>
		<div class="case__block">
			<div class="case__block-head">
				...
				<p class="case__text">Современный дизайн по ГОСТ, удобное расположение информации для читателя.</p>
			</div>
