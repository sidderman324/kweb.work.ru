...
<head>
	...
	<meta name="description" content="PRIDEMAX производство видеороликов" />
	<title>PRIDEMAX производство видеороликов</title>
</head>
	...
	<div class="container">
		...
		<div class="case__block">
			<div class="case__block-head">
				...
				<h1 class="case__title case__title--main">PRIDEMAX производство видеороликов</h1>
				<p class="case__text case__text--date">Дата выпуска: 20.02.2018</p>
			</div>
			<div class="case__frame-wrapper">
				<div class="case__frame">
					<img src="/img/pride_max_site.png" alt="" class="case__frame-img">
				</div>
			</div>
		</div>
		<div class="case__block">
			<div class="case__block-head">
				...
				<p class="case__text">Представление компании в интернете, пробный запуск нового канала. Дизайн с медиа-контентом и портфолио.</p>
			</div>
