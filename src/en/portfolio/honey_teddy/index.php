...
<head>
	...
	<meta name="description" content="HONEY TEDDY Vitamins for Hair" />
	<title>HONEY TEDDY Vitamins for Hair</title>
</head>
			...
			<div class="container">
				...
				<div class="case__block">
					<div class="case__block-head">
						...
						<h1 class="case__title case__title--main">HONEY TEDDY Vitamins for Hair</h1>
				...
				<div class="case__block">
					<div class="case__block-head">
						...
						<p class="case__text">The launch of a new product. Search and testing of promotion channels.</p>
					</div>
