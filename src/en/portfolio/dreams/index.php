...
<head>
	...
	<meta name="description" content="7 DREAMS event management" />
	<title>7 DREAMS event management</title>
</head>
	...
	<div class="container">
		...
		<div class="case__block">
			<div class="case__block-head">
				...
				<h1 class="case__title case__title--main">7 DREAMS event management</h1>
		...
		<div class="case__block">
			<div class="case__block-head">
				...
				<p class="case__text">Attracting customers to a new market (Moscow). Creating a unique design, and showcasing the scale and level of events, organized by the company. Use of media content.</p>
			</div>
