...
<head>
	...
	<meta name="description" content="AQUARIUS automated watering systems" />
	<title>AQUARIUS automated watering systems</title>
</head>
	...
	<div class="container">
		...
		<div class="case__block">
			<div class="case__block-head">
				...
				<h1 class="case__title case__title--main">AQUARIUS automated watering systems</h1>
				<p class="case__text case__text--date">Release date: 20.02.2018</p>
			</div>
			<div class="case__frame-wrapper">
				<div class="case__frame">
					<img src="/img/aquaris_site.png" alt="" class="case__frame-img">
				</div>
			</div>
		</div>
		<div class="case__block">
			<div class="case__block-head">
				...
				<p class="case__text">We helped search for new customers for their products. The focus was put on townhouses and large volumes of irrigation. Big clients were added to the portfolio.</p>
			</div>
