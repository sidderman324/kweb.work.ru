...
<head>
	...
	<meta name="description" content="MINISTRY OF INDUSTRY AND SCIENCE OF SVERDLOVSK REGION" />
	<title>MINISTRY OF INDUSTRY AND SCIENCE OF SVERDLOVSK REGION</title>
</head>
	...
	<div class="container">
		...
		<div class="case__block">
			<div class="case__block-head">
				...
				<h1 class="case__title case__title--main">MINISTRY OF INDUSTRY AND SCIENCE OF SVERDLOVSK REGION</h1>
		...
		<div class="case__block">
			<div class="case__block-head">
				...
				<p class="case__text">Modern design according to government standards, convenient location of information for the reader.</p>
			</div>
