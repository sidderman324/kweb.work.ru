...
<head>
	...
	<meta name="description" content="TITAN CARS help in choosing a used car" />
	<title>TITAN CARS help in choosing a used car</title>
</head>
			...
			<div class="container">
				...
				<div class="case__block">
					<div class="case__block-head">
						...
						<h1 class="case__title case__title--main">TITAN CARS help in choosing a used car</h1>
				...
				<div class="case__block">
					<div class="case__block-head">
						...
						<p class="case__text">We helped this company operate on the Internet and search for new channels for customer attraction.</p>
					</div>
