...
<head>
	...
	<meta name="description" content="DOORNK entrance and connecting doors" />
	<title>DOORNK entrance and connecting doors</title>
</head>
	...
	<div class="container">
		...
		<div class="case__block">
			<div class="case__block-head">
				...
				<h1 class="case__title case__title--main">DOORNK entrance and connecting doors</h1>
		...
		<div class="case__block">
			<div class="case__block-head">
				...
				<p class="case__text">Searching for new promotion channels and ways to increase traffic. Working with conversion.</p>
			</div>
