		...
		<nav class="main-menu">
			<ul class="main-menu__list">
				...
				<li class="main-menu__item <?php echo $dev; ?>"><a class="main-menu__link main-menu__link--hidden">Веб разработка</a>
					<ul class="submenu">
						<li class="submenu__item"><a href="/dev/websitedev.php" class="submenu__link">Разработка сайтов и сервисов</a></li>
						<li class="submenu__item"><a href="/dev/seo.php" class="submenu__link">SEO продвижение сайтов</a></li>
						<li class="submenu__item"><a href="/dev/smm.php" class="submenu__link">SMM и SMO</a></li>
						<li class="submenu__item"><a href="/dev/marketing.php" class="submenu__link">Интернет маркетинг</a></li>						
					</ul>
				</li>
