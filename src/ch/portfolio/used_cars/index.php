...
<head>
	...
	<meta name="description" content="TITAN CARS помощь в выборе поддержанного авто" />
	<title>TITAN CARS помощь в выборе поддержанного авто</title>
</head>
			...
			<div class="container">
				...
				<div class="case__block">
					<div class="case__block-head">
						...
						<h1 class="case__title case__title--main">TITAN CARS помощь в выборе поддержанного авто</h1>
						<p class="case__text case__text--date">Дата выпуска: 20.02.2018</p>
					</div>
					<div class="case__frame-wrapper">
						<div class="case__frame">
							<img src="/img/used_cars_site.png" alt="" class="case__frame-img">
						</div>
					</div>
				</div>
				<div class="case__block">
					<div class="case__block-head">
						...
						<p class="case__text">Вывод компании в интернет в поисках нового канала клиентов</p>
					</div>
