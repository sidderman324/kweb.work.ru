...
<head>
	...
	<meta name="description" content="7 DREAMS организация мероприятий" />
	<title>7 DREAMS организация мероприятий</title>
</head>
	...
	<div class="container">
		...
		<div class="case__block">
			<div class="case__block-head">
				...
				<h1 class="case__title case__title--main">7 DREAMS организация мероприятий</h1>
				<p class="case__text case__text--date">Дата выпуска: 20.02.2018</p>
			</div>
			<div class="case__frame-wrapper">
				<div class="case__frame">
					<img src="/img/dreams_site.png" alt="" class="case__frame-img">
				</div>
			</div>
		</div>
		<div class="case__block">
			<div class="case__block-head">
				...
				<p class="case__text">Привлечение клиентов на новом рынке (Москва). Уникальность дизайна, показать масштабность и уровень мероприятий, организованны компанией. Использование медиа-контента.</p>
			</div>
		...
		<div class="case__block case__block--tag">
			<div class="portfolio__tag-wrapper">
				<a href="#" class="portfolio__tag">Разработка сайтов</a>
			</div>
		</div>
	</div>
</section>
