...
<head>
	...
	<meta name="description" content="ДВЕРНЯК входные и межкомнатные двери" />
	<title>ДВЕРНЯК входные и межкомнатные двери</title>
</head>
	...
	<div class="container">
		...
		<div class="case__block">
			<div class="case__block-head">
				...
				<h1 class="case__title case__title--main">ДВЕРНЯК входные и межкомнатные двери</h1>
				<p class="case__text case__text--date">Дата выпуска: 20.02.2018</p>
			</div>
			<div class="case__frame-wrapper">
				<div class="case__frame">
					<img src="/img/doors_site.png" alt="" class="case__frame-img">
				</div>
			</div>
		</div>
		<div class="case__block">
			<div class="case__block-head">
				...
				<p class="case__text">Поиск новых каналов продвижения, высокий трафик. Работа с конверсией</p>
			</div>
